...
<section style="background-color: #00008B" class="banner-section">
    <div class="container">
        <h2>Avec La Boite A Outils, vous êtes vu par les bonnes personnes, au bon moment !<a href="{{route('allServices')}}" class="button-one">NOS SERVICES</a></h2>
    </div>
</section>

@if(Session::has('SuccesInsertMessage'))

    <div class="alert alert-success alert-dismissable">
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
        {{Session::get('SuccesInsertMessage')}} <strong><i class="glyphicon glyphicon-thumbs-up"></i></strong>
    </div>
@endif
<!-- End banner section -->
...
<section class="projects-section">
    <div class="container">
        ...
        <ul class="filter">
            ...
            <li><a href="#" data-filter=".{{$categorie->intitule}}">{{$categorie->intitule}}</a></li>
                @endforeach
        </ul>
        <div class="project-box iso-call">
            @foreach($allMidleImages as $articles)
            <div class="project-post buildings {{$categories[$articles->categories]}}">
                <img class="img-rounded" src="{{$articles->lienImage}}" alt="">
                <div class="hover-box">
                    <h2><a href="#">{{$articles->intitule}}</a></h2>
