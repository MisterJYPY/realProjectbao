            ...
            <ul>	<!-- SLIDE  -->
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"  data-title="Intro Slide">
                    ...
                    <div class="tp-caption lfr tp-resizeme rs-parallaxlevel-0"
                         ...
                         data-endelementdelay="0.1"
                         data-linktoslide="next"
                         style="z-index: 11; max-width: auto; max-height: auto; white-space: nowrap;"><a href='<?php echo e(route('galerie')); ?>' class='trans-btn2'>Galerie</a>
                    </div>
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-saveperformance="on"  data-title="Ken Burns Slide">
                    <!-- MAIN IMAGE -->
                    <img src="images/dummy.png"  alt="2" data-lazyload="upload/slide/bao_bg2.jpg" data-bgposition="right top" data-kenburns="on" data-duration="12000" data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center bottom">
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption lfb tp-resizeme rs-parallaxlevel-0"
                         ...
                         data-endelementdelay="0.1"
                         data-linktoslide="next"
                         style="z-index: 12; max-width: auto; max-height: auto; white-space: nowrap;"><a href='<?php echo e(route('galerie')); ?>' class='trans-btn'>Savoir Faire</a>
                    </div>
                </li>
                <!-- SLIDE  -->
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="offer-post">
                    <a href="<?php echo e(route('imprimerie')); ?>"><img src="upload/others/bao_himprim.jpg" alt=""></a>
            ...
            <div class="col-md-3">
                <div class="offer-post">
                    <a href="<?php echo e(route('serigraphie')); ?>"><img src="upload/others/bao_hserig.jpg" alt=""></a>
            ...
            <div class="col-md-3">
                <div class="offer-post">
                    <a href="<?php echo e(route('bonneterie')); ?>"><img src="upload/others/bao_hmaroquinerie.jpg" alt=""></a>
            ...
            <div class="col-md-3">
                <div class="offer-post">
                    <a href="<?php echo e(route('evenementiel')); ?>"><img src="upload/others/bao_hevent.jpg" alt=""></a>
...
<section class="about-section">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <video style="margin-bottom:5px"  width="350" height="200" controls="controls"><source src="<?php echo e($uniqueVideo[0]['lien']); ?>" type="video/mp4"/></video>
