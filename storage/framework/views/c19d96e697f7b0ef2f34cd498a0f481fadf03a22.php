<?php $__env->startSection('content'); ?>
  <?php if(Session::has('welcomeCatalogue')): ?>

    <div class="alert alert-info alert-dismissible">
      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
      <?php echo e(Session::get('welcomeCatalogue')); ?> <strong><i class="glyphicon glyphicon-thumbs-up"></i></strong>
    </div>
  <?php endif; ?>
      <section class="forms">
            ...
            <div class="col-lg-6">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo e(route('admin.catalogue.insert')); ?>" method="post" class="form" enctype="multipart/form-data">
